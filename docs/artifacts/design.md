...
| --- | --- | --- |
| `files` | A complete directory with at least one file | File browser and selected-file viewer; text opens as source, with rendered HTML/Markdown, media previews, and downloads |
