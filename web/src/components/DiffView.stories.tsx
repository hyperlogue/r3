...
import { DiffView, RoundSelect } from "./DiffView.tsx";
...
// The full multi-round experience: a toolbar with the `RoundSelect` dropdown
// docked to the right, the selected round wired through `activeSeq` (as
// ReviewView does). Open the dropdown to switch which round the file panel shows;
// the newest round wears a "latest" badge.
