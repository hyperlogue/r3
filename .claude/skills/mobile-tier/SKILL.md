...
a **Go to the latest version** button in that version section; it also closes the
popover when selected. The artifact title and actions occupy the shared top navigation,
